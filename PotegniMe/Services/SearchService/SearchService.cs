...
namespace PotegniMe.Services.SearchService
{
    public class SearchService : ISearchService
    {
        ...
        public async Task<ScrapedTorrentsResponseDto> GetScrapedTorrentsAsync(SearchRequestDto request)
        {
            ...
            // Call potegnime-scrapper express.js PotegniMe route /search
            string baseUrl = _configuration["potegnime-scraper:Url"] ?? throw new Exception("Cannot find potegnime-scraper PotegniMe URL");
            ...
            {
                //potegnime-scrapper PotegniMe returns 500 general error - either down or scraping failed
        ...
        {
            // Call potegnime-scrapper express.js PotegniMe route /categories
            string baseUrl = _configuration["potegnime-scraper:Url"] ?? throw new Exception("Cannot find potegnime-scraper PotegniMe URL");
        ...
        {
            // Call potegnime-scrapper express.js PotegniMe route /providers
            string baseUrl = _configuration["potegnime-scraper:Url"] ?? throw new Exception("Cannot find potegnime-scraper PotegniMe URL");
